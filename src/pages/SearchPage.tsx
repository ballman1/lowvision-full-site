    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-14">
      ...
      <form onSubmit={handleSubmit}>
        <input
          ...
          className="w-full px-4 py-3 text-base border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600 mb-4"
          autoFocus
        />
        <button
          type="submit"
          className="w-full px-4 py-3 bg-blue-700 text-white font-semibold rounded-xl hover:bg-blue-800 transition-colors mb-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700"
        >
          Search
        </button>
      </form>
